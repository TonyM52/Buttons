...
char statename[10] = "empty";

char laststatename[10] = "was empty";
...
if (x<50) {
 state = 1;  // - i.e. Right
 char statename[10] = "Right";
}

else if (x<200) {
  state = 2; // state = Up
 char statename[10] = "Up";
}

else if (x<400) {
  state = 3;  //state = Down
 char statename[10] = "Down";
}

else if (x<600) {
  state = 4;  // state = Left
 char statename[10] = "Left";
}

else if (x<800) {
  state = 5;  // state = Select
 char statename[10] = "Select";
}

else if (x>1000){
 char statename[10] = "No press!";
}
...
if (state == 1) {
  ...
  Serial.print (statename); Serial.println ("  State = 1 - Right");
  delay(200);
}  else if (state == 2) {
  Serial.print ("x = "); Serial.print (x);
  Serial.println ("  State = 2 - Up");
    delay(200);
} else if (state == 3) {
 Serial.print ("x = "); Serial.print (x);
  Serial.println (" State = 3 - Down");
    delay(200);
} else if (state == 4) {
Serial.print ("x = "); Serial.print (x);
  Serial.println ("  State = 4 - Left");
    delay(200);
} else if (state == 5) {
Serial.print ("x = "); Serial.print (x);
  Serial.println ("  State = 5 - Select");
    delay(200);
}
